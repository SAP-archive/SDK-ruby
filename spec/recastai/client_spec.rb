...
describe RecastAI::Client do
  ...
  it 'should perform a text converse' do
    client = RecastAI::Client.new('testtoken')
  ...
  it 'should accept options overrides' do
    ...
    text_conversation = client.text_converse('This is my text', token: 'tokentest', language: 'fr', conversation_token: 'conversationtokentest', memory: { lieu: { lat: 0.54, lnt: 0.435 } })
